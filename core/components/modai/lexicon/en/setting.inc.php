...
$_lang['setting_modai.global.text.temperature_desc'] = 'Higher values like 0.8 will be more random and creative, while values lower than 0.2 will be more focused and deterministic. Set value to -1 to disable it.';
...
$_lang['setting_modai.init.media_browser_desc'] = 'If enabled, modAI will display generate icon in the media browser.';
